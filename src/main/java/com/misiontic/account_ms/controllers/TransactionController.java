...
import com.misiontic.account_ms.exceptions.InsufficentBalanceException;
...
public class TransactionController {
    ...
    Transaction newTransaction(@RequestBody Transaction transaction){
        Account accountOrigin = accountRepository.findById(transaction.getUsernameOrigin()).orElse(null); //obtiene el id del la cuenta de origen
        Account accountDestinity= accountRepository.findById(transaction.getUsernameDestiny()).orElse(null); //obtiene el id de la cuenta de destino
